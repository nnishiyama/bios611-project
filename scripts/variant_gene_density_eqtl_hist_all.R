...
ggplot(var %>% filter(num_eqtl > 0), aes(num_eqtl)) + geom_histogram(binwidth=1, color="black", fill="white") + ggtitle('eQTL Density for All Significant eQTL Variants') + labs(x = 'Number of eQTL per eQTL Variant')
