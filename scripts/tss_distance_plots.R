...
ggplot(distr, aes(tss_distance)) + geom_histogram(color = 'black', fill = 'white') + geom_vline(xintercept = 0, color = 'red',linetype = 'dashed') + ggtitle('Distribution of significant eQTLs variants from gene') + labs(x = 'Distance to Gene TSS')
